...
import com.example.prak12.repo.RepoDataSiswa
import retrofit2.Response

class EntryViewModel(private val repoDataSiswa: RepoDataSiswa):
    ViewModel() {
    ...
    suspend fun addSiswa() {
        if (validasiInput()) {
            val sip: Response<Void> = repoDataSiswa.postDataSiswa(uiStateSiswa
